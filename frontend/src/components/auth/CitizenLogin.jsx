  ...
  return (
    <div className="role-login-overlay" onClick={onClose}>
      <section className="role-login-modal" style={{ '--login-accent': '#08b879', '--login-soft': '#e7fff4' }} onClick={(event) => event.stopPropagation()} aria-label="Citizen Login">
        ...
        <form className="role-login-form" onSubmit={(event) => { event.preventDefault(); onLogin('citizen', 'Citizen Login'); }}>
          <label><span>Mobile Number / Email</span><div className="role-login-input"><Phone size={15} /><input type="text" placeholder="Mobile Number / Email" required /></div></label>
